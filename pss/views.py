    ...
    if user_current_proj_checker:
        ...
        if cart_items:
            ...
            for c in cart_items:
                ...
                pdf.rect(130, 93, 65, 30)
                pdf.rect(15, 93, 65, 30)
                ...
                pdf.cell(90)
                pdf.cell(32, 2, txt="Project Location:  " + user_current_proj_name.location, ln=1, align='L')
                pdf.ln(3)
                pdf.cell(20, 2, txt="Consultant Name:  " + user_current_proj_name.consultant_name, align='L')
                pdf.cell(90)
                pdf.cell(32, 2, txt="Project Date:  " + user_current_proj_name.project_date.strftime("%d-%m-%Y"), ln=1, align='L')
                pdf.ln(3)
                pdf.cell(20, 2, txt="Client Name:  " + user_current_proj_name.client_name, align='L')
                pdf.cell(90)
                pdf.cell(32, 2, txt="Prepared By:  " + user_current_proj_name.prepared_by, align='L')
                pdf.ln(10)
                pdf.ln(2)
                pdf.set_font("Times", size=12,style='B')
                pdf.cell(20,2,txt="Selection Details",ln=1)
                ...
                pdf.line(109, 68.5, 108, 71)
                pdf.line(109, 68.5, 110, 71)
                pdf.line(108, 71, 110, 71)
                ...
                pdf.cell(5)
                pdf.cell(20,6, txt="4. Air leakage through the damper shall be within 2% tolerance at an inlet static pressure of 750Pa.", align='L', ln=1)
                pdf.cell(5)
